...
local initialize = function() 
    ...
    local sprites = {
        idle = load_sprite("samus_idle", "sSamusIdle.png", 5, 14, 18),
        walk = load_sprite("samus_walk", "sSamusRun.png", 5, 12, 20),
        jump = load_sprite("samus_jump", "sSamusRun.png", 5, 12, 20),
        jump_peak = load_sprite("samus_jump_peak", "sSamusRun.png", 5, 12, 20),
        fall = load_sprite("samus_fall", "sSamusRun.png", 5, 12, 20),
        climb = load_sprite("samus_climb", "sSamusRun.png", 5, 12, 20),
        climb_hurt = load_sprite("samus_climb_hurt", "sSamusRun.png", 5, 12, 20), 
        death = load_sprite("samus_death", "sSamusRun.png", 5, 12, 20),
        decoy = load_sprite("samus_decoy", "sSamusRun.png", 5, 12, 20),
    }
