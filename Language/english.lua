   ...
   skill = {
	...
	survivor = {
		hunter = {
           ...
           description = "The <y>Hunter</c> is a galactic warrior who collects relics <r>(not yet implemented)</c> from an <y>ancient race</c> to <y>expand her abilities</c>. Use <y>Missiles</c> to blast huddled groups of enemies and <y>Morph Bombs</c> to lay a trap while making a clean getaway. Remember that you can <y>walljump</c> or propel yourself up with <y>Bombs</c> to scale heights!",
           name =  "Hunter",
           nameUpper = "HUNTER",
           ...
           id = "Travel ID: 0806198638809272007",
